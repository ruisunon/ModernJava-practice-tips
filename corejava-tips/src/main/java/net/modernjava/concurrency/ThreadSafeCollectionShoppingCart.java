 ...
 */
public class ThreadSafeCollectionShoppingCart {
    private ConcurrentHashMap<String, Integer> items;

    public ThreadSafeCollectionShoppingCart() {
    ...
    public void removeItems(String product, int quantity) {
        items.computeIfPresent(product, (key, value) -> (value > quantity) ? value - quantity : 0);
    }
    ...
    public static void main(String[] args) {
        ThreadSafeCollectionShoppingCart cart = new ThreadSafeCollectionShoppingCart();
